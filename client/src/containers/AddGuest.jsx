/* This container will display inside the content component depending on the route.  It will provide the form and functionality for adding a new guest. */
...
class AddGuest extends Component {
	constructor(props) {
		...
		// bind 'this' to the methods in this container 
	...
	// this method will trigger when the submit button is clicked.  it will check the inputs for errors and then initiate the createNewGuest method to actually create the guest.
