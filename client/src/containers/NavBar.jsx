/* This container will render inside the dashboard page.  It will hold the left side navigation components. */
...
function mapStateToProps(state) {
    // whatever gets returned from this method will show up as props inside of this component.  this function is the glue between react and redux.
    return {
		venue: state.venue,
        events: state.events  
    };
