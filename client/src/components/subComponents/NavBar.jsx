...
const NavBar = ({events, selectEvent}) => {
	return (			
		<div className="row event-tab-row" style={{paddingRight:"0px", paddingTop:"0px", marginRight:"0px", marginTop:"0px", borderRightStyle:"solid", borderColor:"white", borderWidth:"1px"}}>
