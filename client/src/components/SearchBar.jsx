/* This component will be rendered in the EventDetail component.
It will control which guests are visible on the guest list (to provide
filtering capability). It also has a quick link to add a new guest. */
